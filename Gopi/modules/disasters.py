...
from Gopi.modules.helper_funcs.chat_status import dev_plus, sudo_plus, whitelist_plus
...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "Gopi/elevated_users.json")
